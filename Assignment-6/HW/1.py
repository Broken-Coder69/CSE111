class Movie:
    ...
    # @classmethod
    # def createMovie_fromString(cls, string):
    #     cls.objectCreation(name = "obj", string = string)
        
        
        
    # @classmethod
    # def objectCreation(cls, name, string):
    #     name = "obj"
    #     temp_quiz_object = cls(name)
    #     lst = string.split('-')         #['Easy', 'Medium', 'Hard']
    #     for question_type in lst:
    #         temp_question_object = Movie(question_type)
    #         temp_quiz_object.add_questions(temp_question_object)
    #     return temp_quiz_object
    ...
    # @classmethod
    # def create_quiz(cls, name, st):
    #     temp_quiz_object = cls(name)
    #     lst = st.split('-')         #['Easy', 'Medium', 'Hard']
    #     for question_type in lst:
    #         temp_question_object = Question(question_type)
    #         temp_quiz_object.add_questions(temp_question_object)
    #     return temp_quiz_object
...
class StarCinema:
    ...
    def addMovies(self, *movie_objects):
        ...
        for i in movie_list:
            ...
            StarCinema.all_branch_info[self.branch_name] = self.movie_list
            # print(i.StarCinema.all_branch_info)
        # StarCinema.all_branch_info[self.branch_name] = self.movie_list
        # print(StarCinema.all_branch_info)
